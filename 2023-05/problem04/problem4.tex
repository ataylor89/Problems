Problem 4: Let $c > 0$ be a real number. Prove that $\displaystyle \sum_{n=1}^\infty \frac{n!}{(cn)^n}$ converges if $\displaystyle c > \frac{1}{e}$ and diverges if $\displaystyle c < \frac{1}{e}$.
